function [words]=Load_Reference_my_DB_UTF8_tfidf(degree)

    str1='D:\Doctorat\Program_Code_Source\My_DB_UTF8\3.My_DB_UTF8_tfidf-';
    str12='l-';
    %degree=1;
...
for i=1:2:length(words{1,j})
    
    %words{1,j}{i,3}=num2str(words{1,j}{i+1,1});
    words{1,j}{i,2}=num2str(words{1,j}{i+1,1});
